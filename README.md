...
- **UPC**: "Enhancing User-Oriented Proactivity in Open-Domain Dialogues with Critic Guidance". *arXiv(2025)* [📄 paper](https://arxiv.org/abs/2505.12334) [💻 code](https://github.com/wang678/LLM-UPC)  📌
- **Non-collaborative**: "Strength Lies in Differences! Improving Strategy Planning for Non-collaborative Dialogues via Diversified User Simulation". *EMNLP(2024)* [📄 paper](https://aclanthology.org/2024.emnlp-main.26/) 📌
...
- **DMCRL**: "Enhancing Goal-oriented Proactive Dialogue Systems via Dynamic Multi-dimensional Consistency Optimization". *EMNLP-Findings(2025)* [📄 paper](https://aclanthology.org/2025.findings-emnlp.1378/)  📌 
...
- **TopDial**: "Target-oriented Proactive Dialogue Systems with Personalization: Problem Formulation and Dataset Curation". *EMNLP(2023)* [📄 paper](https://aclanthology.org/2023.emnlp-main.72/) [💻 code](https://github.com/iwangjian/TopDial)  ✅
...
- **FusedChat**: "Fusing task-oriented and open-domain dialogues in conversational agents". *AAAI(2022)* [📄 paper]() [💻 code](https://github.com/tomyoung903/FusedChat) 📌
...
- **ESC-LLM**: "From Personas to Talks: Revisiting the Impact of Personas on LLM-Synthesized Emotional Support Conversations". *EMNLP(2025)* [📄 paper](https://aclanthology.org/2025.emnlp-main.277/) 📌
...
- **AskBeforePlan**: "Ask-before-Plan: Proactive Language Agents for Real-World Planning". *EMNLP-Findings(2024)* [📄 paper](https://aclanthology.org/2024.findings-emnlp.636/) [💻 code](https://github.com/magicgh/Ask-before-Plan) 📌
- **PCQPR**: "PCQPR: Proactive Conversational Question Planning with Reflection". *EMNLP(2024)* [📄 paper](https://aclanthology.org/2024.emnlp-main.631/) 📌 
...
- **QGStepByStep**: "Guiding the Growth: Difficulty-Controllable Question Generation through Step-by-Step Rewriting". *ACL(2021)* [📄 paper](https://aclanthology.org/2021.acl-long.465/) [💻 code](https://drive.google.com/drive/folders/1pF3IM9HbNS4w8OlhuSjH1YSLlb5rjaF3) 📌 
